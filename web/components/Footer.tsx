      ...
      <div className="wrap foot-main">
        <div className="foot-left">
          ...
          <div className="foot-cols">
            <div className="foot-col">
              ...
              <Link href="/#features">Element presence</Link>
              <Link href="/#features">Color &amp; contrast</Link>
              <Link href="/#features">Typography</Link>
              <Link href="/#features">Spacing &amp; layout</Link>
              <Link href="/#features">Icons &amp; images</Link>
              <Link href="/#features">Text similarity</Link>
              <Link href="/#features">Image quality</Link>
            </div>
            <div className="foot-col">
              <h4>Product</h4>
          ...
          <div className="foot-bottom">
            ...
            <span className="foot-legal"><a href="#">Privacy Statement</a> &nbsp;|&nbsp; <a href="#">Terms of Use</a></span>
          </div>
        </div>
        <div className="foot-right">
          ...
          <div className="foot-cta-btns">
            <a className="foot-btn outline" href="mailto:hello@koderlabs.com">Contact Us</a>
            <Link className="foot-btn solid" href="/#run">Start a QA</Link>
          </div>
          <div className="foot-contact">
            <a href="mailto:hello@koderlabs.com"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><rect x="2" y="4" width="20" height="16" rx="2" /><path d="m22 6-10 7L2 6" /></svg> hello@koderlabs.com</a>
            <a href="https://koderlabs.com" target="_blank" rel="noopener noreferrer"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><circle cx="12" cy="12" r="10" /><path d="M2 12h20M12 2a15 15 0 0 1 0 20 15 15 0 0 1 0-20" /></svg> koderlabs.com</a>
          </div>
        </div>
      </div>
    </footer>
